...
class Home extends Component {
    render() {
        const mainImage = require('../assets/picture.jpg');
        const newImages = [
            { source: require('../assets/palestine-flag-collage-lz8395cug144za2z.jpg'), title: 'Palestine flag', subtitle: '10$' },
            { source: require('../assets/palestine.jpg'), title: 'Palestine', subtitle: '12$' },
            { source: require('../assets/wallpaperflare.com_wallpaper(1).jpg'), title: 'Shindaime', subtitle: '15$' },
            { source: require('../assets/Flag.jpg'), title: 'Flag', subtitle: '15$' },
